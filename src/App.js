...
const LEGISLATION_DB = {
  ...
  "Contract Law": {
    ...
    items: [
      { name: "Contracts (Rights of Third Parties) Act 2001", abbr: "CRTPA", desc: "Allows a third party who is not a party to a contract to enforce a contractual term if the contract expressly provides for it or if the term purports to confer a benefit on the third party. Modifies the traditional privity of contract rule." },
      { name: "Misrepresentation Act 1967", abbr: "MA", desc: "Governs remedies available to a contracting party who was induced to enter a contract by a misrepresentation. Provides for rescission and damages for both fraudulent and negligent misrepresentation, and limits the effectiveness of exclusion clauses in respect of misrepresentation." },
      { name: "Unfair Contract Terms Act 1977", abbr: "UCTA", desc: "Controls the use of exemption clauses in contracts, particularly in standard form business contracts. A party cannot exclude liability for negligence causing death or personal injury, and other exclusion clauses are subject to a reasonableness test." },
      { name: "Sale of Goods Act 1979", abbr: "SOGA", desc: "Governs contracts for the sale of goods in Singapore. Implies conditions as to title, correspondence with description, satisfactory quality, fitness for purpose, and correspondence with sample. Sets out rules on passing of property and risk." },
      { name: "Electronic Transactions Act 2010", abbr: "ETA", desc: "Provides legal certainty for electronic contracts and signatures. Electronic records and signatures are given the same legal effect as paper documents and handwritten signatures, subject to certain exceptions." },
    ],
  },
  "Employment Law": {
    icon: "👔",
    ...
    items: [
      { name: "Employment Act 1968", abbr: "EA", desc: "The principal employment statute in Singapore. Covers core employment terms including salary, working hours, rest days, leave entitlements, and termination. Applies to all employees except managers and executives earning above S$4,500/month (for Part IV provisions)." },
      { name: "Employment of Foreign Manpower Act 1990", abbr: "EFMA", desc: "Regulates the employment of foreign workers in Singapore. Governs the issuance of work passes (including Work Permits, S Passes, and Employment Passes), obligations of employers, and penalties for employing foreigners without valid passes." },
      { name: "Industrial Relations Act 1960", abbr: "IRA", desc: "Governs collective bargaining between trade unions and employers. Sets out the process for recognition of trade unions, collective agreements, and the resolution of trade disputes through conciliation and arbitration by the Industrial Arbitration Court." },
      { name: "Work Injury Compensation Act 2019", abbr: "WICA", desc: "Provides a no-fault compensation scheme for employees who suffer injuries or contract occupational diseases arising from work. Sets out the procedure for claims, compensation amounts, and the roles of insurers and the Commissioner for Labour." },
      { name: "Workplace Safety and Health Act 2006", abbr: "WSHA", desc: "Imposes duties on employers, occupiers, and suppliers to ensure the safety, health, and welfare of persons at workplaces. Establishes a framework for risk management, incident reporting, and regulatory enforcement by the Ministry of Manpower." },
    ],
  },
  "Tort Law": {
    icon: "⚖️",
    ...
    items: [
      { name: "Civil Law Act 1909", abbr: "CLA", desc: "Supplements common law tort principles in Singapore. Notably includes provisions on contributory negligence (apportionment of liability), damages for dependency claims following fatal accidents, and the survival of causes of action after death." },
      { name: "Limitation Act 1959", abbr: "LA", desc: "Sets out the time limits within which civil claims, including tort actions, must be commenced. Generally, claims in tort must be brought within 6 years from the date the cause of action accrued, with special rules for personal injury, latent damage, and fraud." },
      { name: "Defamation Act 1957", abbr: "DA", desc: "Governs the law of defamation in Singapore. Sets out defences including justification (truth), fair comment, and qualified privilege. Also addresses defamation in broadcast media and provides for offers of amends." },
    ],
  },
  "Property Law": {
    icon: "🏠",
    ...
    items: [
      { name: "Land Titles Act 1993", abbr: "LTA", desc: "Establishes the Torrens system of land registration in Singapore. Registered title is indefeasible, meaning that a registered owner's title is conclusive and cannot generally be challenged except in cases of fraud. Governs dealings such as transfers, mortgages, and easements." },
      { name: "Conveyancing and Law of Property Act 1886", abbr: "CLPA", desc: "Governs the sale and conveyancing of property in Singapore, including implied covenants in conveyances, mortgages, leases, and conditions of sale. Still applicable to unregistered land and certain dealings not covered by the Land Titles Act." },
      { name: "Housing and Development Act 1959", abbr: "HDA", desc: "Governs the purchase, sale, and eligibility requirements for HDB (public housing) flats in Singapore. Sets out restrictions on who may own HDB flats, minimum occupation periods, and the resale levy, as well as the powers and functions of the HDB." },
      { name: "Residential Property Act 1976", abbr: "RPA", desc: "Restricts the purchase of landed residential properties by foreigners in Singapore. Foreign persons generally require approval from the Singapore Land Authority before acquiring restricted residential property. Sets out exemptions and penalties for contravention." },
    ],
  },
  "Family Law": {
    icon: "👨‍👩‍👧",
    ...
    items: [
      { name: "Women's Charter 1961", abbr: "WC", desc: "The principal statute governing civil marriages, divorce, and ancillary matters in Singapore. Sets out the grounds for divorce (irretrievable breakdown), financial relief including division of matrimonial assets and maintenance for spouses and children, and custody arrangements." },
      { name: "Guardianship of Infants Act 1934", abbr: "GIA", desc: "Governs applications for guardianship and custody of children. The welfare of the child is the paramount consideration. Courts may appoint guardians and make orders regarding care, control, and access for children of unmarried parents or where no divorce proceedings are involved." },
      { name: "Maintenance of Parents Act 1995", abbr: "MPA", desc: "Allows elderly parents who are unable to maintain themselves adequately to apply to the Tribunal for the Maintenance of Parents for a maintenance order against their children. Promotes filial responsibility and provides an alternative to court litigation." },
      { name: "Family Justice Act 2014", abbr: "FJA", desc: "Establishes the Family Justice Courts in Singapore (comprising the Family Division of the High Court and the Family Courts). Sets out the jurisdiction of these courts over family-related matters including divorce, probate, adoption, and personal protection orders." },
      { name: "Administration of Muslim Law Act 1966", abbr: "AMLA", desc: "Governs matters relating to Muslim personal and family law in Singapore, including Muslim marriages, divorces (administered by the Syariah Court), inheritance under Islamic law (faraid), and the administration of Muslim trusts (wakaf) and mosques." },
    ],
  },
  "Criminal Law": {
    icon: "🔒",
    ...
    items: [
      { name: "Penal Code 1871", abbr: "PC", desc: "The principal criminal statute in Singapore, defining a wide range of offences including offences against the person (assault, hurt, homicide), property offences (theft, cheating, criminal breach of trust), and public order offences. Sets out the elements of each offence and applicable punishments." },
      { name: "Criminal Procedure Code 2010", abbr: "CPC", desc: "Governs the procedure for criminal investigations, arrests, bail, trials, and appeals in Singapore. Sets out the powers of the police and prosecutors, rules of evidence in criminal proceedings, and the rights of accused persons at each stage of the criminal process." },
      { name: "Evidence Act 1893", abbr: "EA", desc: "Governs the admissibility and weight of evidence in both civil and criminal proceedings in Singapore. Sets out rules on relevancy, oral evidence, documentary evidence, burden of proof, and privileges. Courts are bound by the Act in determining what evidence may be relied upon." },
      { name: "Misuse of Drugs Act 1973", abbr: "MDA", desc: "Governs the possession, trafficking, manufacture, and import/export of controlled drugs in Singapore. Prescribes severe mandatory minimum sentences including the death penalty for drug trafficking above specified quantities. Includes presumptions of trafficking from quantities possessed." },
    ],
  },
};
